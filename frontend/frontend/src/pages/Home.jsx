    ...
    <>
      ...
      <div className="relative h-screen w-full flex items-center justify-start overflow-hidden bg-white px-4">
        ...
        <div className="relative z-10 w-full md:w-1/2 text-left space-y-5 px-4 md:px-1" data-aos="fade-up" data-aos-duration="2000">
          <h1 className="text-4xl md:text-6xl font-bold text-orange-500 transition-all duration-1000 ease-in whitespace-nowrap">
            Welcome to <span className="text-white voteBharatText">VoteBharat!</span>
          </h1>
          <p className="text-xl md:text-2xl text-white">{currentTagline}</p>
          <button
